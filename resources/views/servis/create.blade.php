<x-app-layout>
    <x-slot name="header">
        <h5 class="mb-0">Tambah Servis</h5>
    </x-slot>
            ...
            <form method="POST" action="{{ route('servis.store') }}" enctype="multipart/form-data">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input id="tanggal" name="tanggal" type="date" class="form-control" value="{{ old('tanggal') }}" required>
                        <x-input-error :messages="$errors->get('tanggal')" />
                    </div>
                    <div class="col-md-6">
                        <x-input-label for="bengkel" value="Bengkel *" />
                        <x-text-input id="bengkel" name="bengkel" :value="old('bengkel')" required />
                        <x-input-error :messages="$errors->get('bengkel')" />
                    </div>
                    <div class="col-md-6">
                        <x-input-label for="jenis_servis" value="Jenis Servis *" />
                        <x-text-input id="jenis_servis" name="jenis_servis" :value="old('jenis_servis')" required />
                        <x-input-error :messages="$errors->get('jenis_servis')" />
                    </div>
                    <div class="col-md-4">
                        <x-input-label for="odometer" value="Odometer *" />
                        <x-text-input id="odometer" name="odometer" type="number" :value="old('odometer')" required />
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="input-group">
                            ...
                            <input id="biaya" name="biaya" type="number" step="0.01" class="form-control" value="{{ old('biaya') }}" required>
                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <select id="status" name="status" class="form-select">
                            <option value="jadwal" {{ old('status') == 'jadwal' ? 'selected' : '' }}>Terjadwal</option>
